...
Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, abrindo uma issue no repositório (ou pelo reporte privado de vulnerabilidades do GitHub, em temas sensíveis). Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
