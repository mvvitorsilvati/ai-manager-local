import {
  BookOpen, Cpu, File as FileIcon, FileText, Folder, Image as ImageIcon,
  Shield, Terminal, Zap, type LucideIcon,
} from "lucide-react"
...
const CAT_ICON: Record<string, LucideIcon> = {
  context: BookOpen, skill: Zap, agent: Cpu, command: Terminal, rule: Shield,
  config: FileText, doc: FileText, script: FileIcon, image: ImageIcon,
}
